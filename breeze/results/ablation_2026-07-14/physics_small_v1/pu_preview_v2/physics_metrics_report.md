...
|---|---|---|---|
| pu | llm | available | deterministic_metric_subsample_of_frozen_pool |
| pu | rule | available | deterministic_metric_subsample_of_frozen_pool |
| pu | random_open_loop | available | deterministic_metric_subsample_of_frozen_pool |
...
- `nn_diversity`: mean nearest-neighbour distance among synthetic physical feature vectors after real-reference scaling; `real_nn_diversity` is the corresponding real-reference value.
